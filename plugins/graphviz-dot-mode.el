...
(defcustom graphviz-dot-style-keywords
  '("filled" "invis" "diagonals" "rounded" "dashed" "dotted" "solid"
    "bold" )
  "*Keywords for style values. This is used by the auto completion code."
  :type '(repeat (string :tag "Keyword"))
  :group 'graphviz)

(defcustom graphviz-dot-shape-keywords
  '("box" "polygon" "ellipse" "oval" "circle" "point" "egg" "triangle"
    "plaintext" "plain" "diamond" "trapezlum" "parallelogram" "house"
    "pentagon" "hexagon" "septagon" "octagon" "doublecircle"
    "doubleoctagon" "tripleoctagon" "invtriangle" "invtrapezium" "invhouse"
    "Mdiamond" "Msqure" "Mcircle" "rect" "rectangle" "square" "star"
    "none" "underline" "cylinder" "note" "tab" "folder" "box3d" "component"
...
(defvar graphviz-style-keywords
  (mapcar #'(lambda (elm) (cons elm 0)) graphviz-dot-style-keywords))

(defvar graphviz-shape-keywords
  (mapcar #'(lambda (elm) (cons elm 0)) graphviz-dot-shape-keywords))
